...
const SOUND_OPTIONS: { id: AlarmSoundType; label: string; desc: string }[] = [
  { id: 'default', label: 'Default Alarm', desc: 'Dual pitch synth pulse' },
  { id: 'beep', label: 'Classic Beep', desc: 'Clear single tone' },
  { id: 'digital', label: 'Digital Alarm', desc: 'Futuristic triple tone' },
  { id: 'bell', label: 'Gentle Bell', desc: 'Soft bell chime' },
  { id: 'siren', label: 'Emergency Siren', desc: 'High urgency sweep' },
];
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <select
          ...
          className="w-full px-3 py-2.5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl text-xs sm:text-sm text-slate-900 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 shadow-xs"
        >
